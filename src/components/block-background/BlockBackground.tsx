...
const BlockBackground: FC<BlockBackgroundProps> = ({mediatorsClasses,...props}) => {
  return (
    <div className={['block-background', props.className].join(' ')}>
      {props.children}
      <TopLeftMediator className={concatStyles('block-background__mediator', mediatorsClasses.topLeft)}/>
      <TopRightMediator className={concatStyles('block-background__mediator', mediatorsClasses.topRight)}/>
      <BottomLeftMediator className={concatStyles('block-background__mediator', mediatorsClasses.bottomLeft)}/>
      <BottomRightMediator className={concatStyles('block-background__mediator', mediatorsClasses.bottomRight)}/>
   </div>
  )
}
