    ...
    <div className="team-data__wrapper">
      <div className="team-data__insideblock">
        <div className="up_block">
          ...
          <div className="count__players">{playersCount} чел.</div>
        </div>
        <div className="team-leader__data">
          <span className="team-leader__data-name">{contactPlayerName}</span>
          <span className="team-leader__data-phone">{contactPlayerPhone}</span>
        </div>
        <div className="team-status__block">
          ...
          <div className="status--buttons">
            {status === 'pending' && <button className="button__approve">Подтвердить</button>}
            <button className="button__delete">
              {status === 'deleted' ? 'Восстановить' : 'Отменить'}
            </button>
          </div>
        </div>
        <div className="block_deposit">{playersCount * 500} р</div>
      </div>
    </div>
  );
};
